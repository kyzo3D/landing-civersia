...
export default function GenerativeAI() {
    return (
        <>
            ...
            <MobileView>
                <section className="mb-11 w-full dark:bg-muted dark">
                    <Iphone15ProV2 className="p-1 -mt-16 w-4/5 mx-auto" src="/img_to_3d.mp4" />
                    <div className="md:px-6 -mt-11">
                        <div className="w-full">
                            <div className="space-y-11 mt-28 p-28">
                                <div>
                                    <div className="relative">
                                        <div className="absolute opacity-70 inset-0 flex items-center justify-center text-4xl font-bold text-gray-600 blur-sm">
                                            <WordPullUp 
