        ...
        <motion.section
          ...
          <div className="grid grid-cols-2 gap-11">
            <div className="col-span-1">
              ...
              <div className="mt-10 h-full border border-white/40 p-3 rounded-3xl">
                <iframe className="w-full h-full bg-white rounded-xl" src="https://calendly.com/civersia?embed_domain=localhost:3000&embed_type=Inline"></iframe>
              </div>
            </div>
            <div>
        ...
        <motion.section
          ...
          <div className="w-full">
            <div className="col-span-1">
              ...
              <div className="my-10 h-full border border-white/40 p-3 rounded-3xl">
                <iframe className="w-full h-[400px] bg-white rounded-xl" src="https://calendly.com/civersia?embed_domain=localhost:3000&embed_type=Inline"></iframe>
              </div>
            </div>
            <div>
              <div className="flex flex-col gap-3 justify-center items-center">
